...
PKGMANAGER = "yum"
FINAL_MESSAGE = "VALIDATE_PACKAGE_MANAGER_TRANSACTION::UNKNOWN_ERROR - Unknown"
...
def test_validation_packages_with_in_name_period(shell, convert2rhel, packages_with_period):
    ...
    with convert2rhel(
        ...
        assert c2r.expect("Unhandled exception was caught: too many values to unpack (expected 2)") == 0
